(function(){
  ...
  /* ---- gyroscope tilt for touch devices (phone/tablet) ---- */
  ...
  function handleOrientation(e){
    ...
    targetTiltX = dBeta * 0.4;
    targetTiltY = dGamma * 0.4;
  }
  ...
  function enableGyro(){
    ...
    if(typeof DeviceOrientationEvent !== 'undefined' && typeof DeviceOrientationEvent.requestPermission === 'function'){
      ...
      }).catch(function(){ /* denied or unsupported — envelope just stays still-but-floating */ });
  ...
  envelope.addEventListener('click', function(){
    ...
    if(gyroActive){ window.removeEventListener('deviceorientation', handleOrientation); }
